...
echo "Step 5: Generating data quality report..."

echo "=== Data Quality Summary ===" > data_quality_report.txt
echo "Original records: $(tail -n +2 "$INPUT_FILE" | wc -l)" >> data_quality_report.txt
echo "Cleaned records: $TOTAL_RECORDS" >> data_quality_report.txt
echo "" >> data_quality_report.txt
echo "Cleaning operations performed:" >> data_quality_report.txt
echo "- Removed Windows line endings" >> data_quality_report.txt
echo "- Normalized whitespace around delimiters" >> data_quality_report.txt
echo "- Removed quotation marks" >> data_quality_report.txt
echo "- Standardized date formats" >> data_quality_report.txt
echo "- Validated amount_due <= total_amount" >> data_quality_report.txt
echo "- Handled NULL/missing values" >> data_quality_report.txt
echo "- Removed invalid records" >> data_quality_report.txt
...
echo "✓ Quality report: data_quality_report.txt"
echo ""
echo "New features added:"
echo "  - Shell-based data cleaning (sed, awk)"
echo "  - Payment delay buckets analysis"
echo "  - Payer reliability scoring"
echo "  - Quarterly revenue trends"
echo "  - Multi-tab interactive dashboard"
